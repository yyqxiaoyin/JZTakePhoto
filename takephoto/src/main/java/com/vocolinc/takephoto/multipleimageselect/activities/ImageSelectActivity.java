package com.vocolinc.takephoto.multipleimageselect.activities;
...
import com.vocolinc.takephoto.multipleimageselect.adapters.CustomImageSelectAdapter;
        ...
        public void run() {
            ...
            if (cursor.moveToLast()) {
                do {
                    ...
                    @SuppressLint("Range") String name = cursor.getString(cursor.getColumnIndex(projection[1]));
